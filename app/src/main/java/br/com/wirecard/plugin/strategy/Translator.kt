        ...
        return when (method) {
            Payment.Method.BOLETO ->
                PaymentMethodTranslate(
                    nameId = R.string.boleto,
                    drawableId = R.drawable.ic_barcode,
                    colorId = R.color.colorPrimary)
            Payment.Method.CREDIT_CARD ->
                PaymentMethodTranslate(
                    nameId = R.string.credit_card,
                    drawableId = R.drawable.ic_payment_card,
                    colorId = R.color.colorPrimary)
            Payment.Method.DEBIT_CARD ->
                PaymentMethodTranslate(
                    nameId = R.string.debit_card,
                    drawableId = R.drawable.ic_payment_card,
                    colorId = R.color.colorPrimary)
            Payment.Method.ONLINE_BANK_DEBIT ->
                PaymentMethodTranslate(
                    nameId = R.string.online_bank_debit,
                    drawableId = R.drawable.ic_payment_card,
                    colorId = R.color.colorPrimary)
            Payment.Method.ONLINE_BANK_FINANCING ->
                PaymentMethodTranslate(
                    nameId = R.string.online_bank_financing,
                    drawableId = R.drawable.ic_payment_card,
                    colorId = R.color.colorPrimary)
            Payment.Method.WALLET ->
                PaymentMethodTranslate(
                    nameId = R.string.wallet,
                    drawableId = R.drawable.ic_payment_card,
                    colorId = R.color.colorPrimary)
        }
    }
